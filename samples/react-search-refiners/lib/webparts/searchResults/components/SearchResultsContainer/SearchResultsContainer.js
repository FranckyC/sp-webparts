...
var SearchResultsContainer = (function (_super) {
    ...
    SearchResultsContainer.prototype.render = function () {
        ...
        if (!isComponentLoading && areResultsLoading) {
            renderOverlay = React.createElement("div", null,
                React.createElement(Overlay_1.Overlay, { isDarkThemed: false, className: "overlay" }));
        }
                ...
                if (items.RelevantResults.length === 0) {
                    ...
                    wpContent =
                        React.createElement("div", null,
                            React.createElement(FilterPanel_1.default, { availableFilters: this.state.availableFilters, onUpdateFilters: this._onUpdateFilters }),
                            renderOverlay,
                            React.createElement(TilesList_1.default, { items: items.RelevantResults, showFileIcon: this.props.showFileIcon, showCreatedDate: this.props.showCreatedDate }),
    ...
    SearchResultsContainer.prototype.componentDidMount = function () {
    ...
    SearchResultsContainer.prototype.componentWillReceiveProps = function (nextProps) {
        return __awaiter(this, void 0, void 0, function () {
            var query, searchResults, error_2;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        query = nextProps.queryKeywords + nextProps.searchDataProvider.queryTemplate + nextProps.selectedProperties.join(',');
                        if (!(this.props.refiners.toString() !== nextProps.refiners.toString()
                            ...
                            || this.props.enableQueryRules !== nextProps.enableQueryRules)) return [3 /*break*/, 4];
                        _a.label = 1;
                    case 1:
                        _a.trys.push([1, 3, , 4]);
     ...
     */
    SearchResultsContainer.prototype._onUpdateFilters = function (newFilters) {
        return __awaiter(this, void 0, void 0, function () {
            var searchResults;
            return __generator(this, function (_a) {
                switch (_a.label) {
     ...
     */
    SearchResultsContainer.prototype._onPageUpdate = function (pageNumber) {
        return __awaiter(this, void 0, void 0, function () {
            var searchResults;
            return __generator(this, function (_a) {
                switch (_a.label) {
...
//# sourceMappingURL=SearchResultsContainer.js.map
